...
class Helper
{
    ...
    {
        if (!file_exists('logs') && !mkdir('logs', 0775) && !is_dir('logs')) {
        ...
        file_put_contents('logs/error.log',   print_r($date, true), FILE_APPEND);
        file_put_contents('logs/error.log', PHP_EOL .print_r($data, true), FILE_APPEND);
        $string = '=====================' . date('Y-m-d H:i:s') . '============================================='.PHP_EOL ;
        file_put_contents('logs/error.log', print_r($string, true), FILE_APPEND);
